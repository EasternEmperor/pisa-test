...
insert into p_pt_question(no, html_name, data_table) values(6, 'cat_feed_t1', 'p_pt_cat_feed_data');
insert into p_pt_question(no, html_name, data_table) values(7, 'cat_feed_t2', 'p_pt_cat_feed_data');
insert into p_pt_question(no, html_name, data_table) values(8, 'perfume_maker_t1', 'p_pt_perfume_maker_data');
insert into p_pt_question(no, html_name, data_table) values(9, 'perfume_maker_t2', 'p_pt_perfume_maker_data');
insert into p_pt_question(no, html_name, data_table) values(10, 'projection_controller_t1', 'p_pt_projection_controller_data');
insert into p_pt_question(no, html_name, data_table) values(11, 'projection_controller_t2', 'p_pt_projection_controller_data');
insert into p_pt_question(no, html_name, data_table) values(12, 'water_dispenser_t1', 'p_pt_water_dispenser_data');
insert into p_pt_question(no, html_name, data_table) values(13, 'water_dispenser_t2', 'p_pt_water_dispenser_data');
insert into p_pt_question(no, html_name, data_table) values(14, 'video_player_t1', 'p_pt_video_player_data');
insert into p_pt_question(no, html_name, data_table) values(15, 'video_player_t2', 'p_pt_video_player_data');
insert into p_pt_question(no, html_name, data_table) values(16, 'big_air_controller_t1', 'p_pt_big_air_controller_data');
insert into p_pt_question(no, html_name, data_table) values(17, 'big_air_controller_t2', 'p_pt_big_air_controller_data');
insert into p_pt_question(no, html_name, data_table) values(18, 'flower_garden_t1', 'p_pt_flower_garden_data');
insert into p_pt_question(no, html_name, data_table) values(19, 'flower_garden_t2', 'p_pt_flower_garden_data');
insert into p_pt_question(no, html_name, data_table) values(20, 'flashlight_t1', 'p_pt_flashlight_data');
insert into p_pt_question(no, html_name, data_table) values(21, 'flashlight_t2', 'p_pt_flashlight_data');
insert into p_pt_question(no, html_name, data_table) values(22, 'rice_cooker_t1', 'p_pt_rice_cooker_data');
insert into p_pt_question(no, html_name, data_table) values(23, 'rice_cooker_t2', 'p_pt_rice_cooker_data');
insert into p_pt_question(no, html_name, data_table) values(24, 'coffee_machine_t1', 'p_pt_coffee_machine_data');
insert into p_pt_question(no, html_name, data_table) values(25, 'coffee_machine_t2', 'p_pt_coffee_machine_data');
insert into p_pt_question(no, html_name, data_table) values(26, 'fruit_tea_t1', 'p_pt_fruit_tea_data');
insert into p_pt_question(no, html_name, data_table) values(27, 'fruit_tea_t2', 'p_pt_fruit_tea_data');
insert into p_pt_question(no, html_name, data_table) values(28, 'camera_controller_t1', 'p_pt_camera_controller_data');
insert into p_pt_question(no, html_name, data_table) values(29, 'camera_controller_t2', 'p_pt_camera_controller_data');
...
create table p_pt_projection_controller_data (
    ...
    projection_value varchar(10) not null default 'NULL' comment '投影大小',
    diagram_state varchar(100) not null default 'NULL' comment '用户答案',
    primary key(id),
    key uk_user_name_ith_answer(user_name, ith_answer)
);
...
create table p_pt_flashlight_data (
    ...
    bottom_setting varchar(10) not null default 'NULL' comment 'bottom control设置的大小',
    last_setting varchar(10) not null default 'NULL' comment 'last control设置的大小',
    distance_value varchar(100) not null default 'NULL' comment '远近大小',
    brightness_value varchar(10) not null default 'NULL' comment '明暗大小',
