...
public class CoffeeMachineDataDO {
    ...
    public String getBitternessValue() {
        return bitternessValue;
    }

    public void setBitternessValue(String bitternessValue) {
        this.bitternessValue = bitternessValue == null ? null : bitternessValue.trim();
    }
    ...
    public String getConsistenceValue() {
        return consistenceValue;
    }

    public void setConsistenceValue(String consistenceValue) {
        this.consistenceValue = consistenceValue == null ? null : consistenceValue.trim();
    }
